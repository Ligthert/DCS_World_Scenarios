...
-- us_rat_1:ExcludedAirports("Krasnodar-Center")
-- us_rat_1:Invisible()
-- us_rat_1:Spawn(5)
...
-- us_rat_2:ExcludedAirports("Krasnodar-Center")
-- us_rat_2:Invisible()
-- us_rat_2:Spawn(5)
...
-- us_rat_3:ExcludedAirports("Krasnodar-Center")
-- us_rat_3:Invisible()
-- us_rat_3:Spawn(5)
...
-- us_rat_4:ExcludedAirports("Krasnodar-Center")
-- us_rat_4:Invisible()
-- us_rat_4:Spawn(5)
