...
us_rat_1:ExcludedAirports("Krasnodar-Center","Senaki-Kolkhi")
us_rat_1:Invisible()
us_rat_1:SetCoalition("sameonly")
us_rat_1:ATC_Messages(false)
us_rat_1:Spawn(5)
...
us_rat_2:ExcludedAirports("Krasnodar-Center","Senaki-Kolkhi")
us_rat_2:Invisible()
us_rat_2:SetCoalition("sameonly")
us_rat_2:ATC_Messages(false)
us_rat_2:Spawn(5)
...
us_rat_3:ExcludedAirports("Krasnodar-Center","Senaki-Kolkhi")
us_rat_3:Invisible()
us_rat_3:SetCoalition("sameonly")
us_rat_3:ATC_Messages(false)
us_rat_3:Spawn(5)
...
us_rat_4:ExcludedAirports("Krasnodar-Center","Senaki-Kolkhi")
us_rat_4:Invisible()
us_rat_4:SetCoalition("sameonly")
us_rat_4:ATC_Messages(false)
us_rat_4:Spawn(5)
...
ru_rat_1:ExcludedAirports("Krasnodar-Center")
ru_rat_1:Invisible()
ru_rat_1:SetCoalition("sameonly")
ru_rat_1:ATC_Messages(false)
ru_rat_1:Spawn(5)
...
ru_rat_2:ExcludedAirports("Krasnodar-Center")
ru_rat_2:Invisible()
ru_rat_2:SetCoalition("sameonly")
ru_rat_2:ATC_Messages(false)
ru_rat_2:Spawn(5)
...
ru_rat_3:ExcludedAirports("Krasnodar-Center")
ru_rat_3:Invisible()
ru_rat_3:SetCoalition("sameonly")
ru_rat_3:ATC_Messages(false)
ru_rat_3:Spawn(5)
...
ru_rat_4:ExcludedAirports("Krasnodar-Center")
ru_rat_4:Invisible()
ru_rat_4:SetCoalition("sameonly")
ru_rat_4:ATC_Messages(false)
ru_rat_4:Spawn(5)
...
ru_rat_5:ExcludedAirports("Krasnodar-Center")
ru_rat_5:Invisible()
